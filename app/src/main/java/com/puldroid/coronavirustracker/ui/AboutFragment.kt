...
class AboutFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val madeBy = SpannableString(
            "Made with ❤️.\n GitHub: github.com/Tanuruha-Majumdar\nLinkedIn: linkedin.com/in/tanuruha-majumdar/\n\n\n©2020 Tanuruha Majumdar All Rights Reserved"
        )
        val privacySpan: ClickableSpan = object : ClickableSpan() {
            override fun onClick(textView: View) {
                requireContext().openChrome("https://github.com/Tanuruha-Majumdar")
            }
        ...
        val tosSpan: ClickableSpan = object : ClickableSpan() {
            override fun onClick(textView: View) {
                requireContext().openChrome("https://linkedin.com/in/tanuruha-majumdar")
            }
